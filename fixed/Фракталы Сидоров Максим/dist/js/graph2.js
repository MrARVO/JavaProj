{
	...
	let H = grafar.set([distBetwen]).select()
	...
	path.forEach((item,i) => {
		...
		let r = grafar.set([color.r / 255]).select()
		let g = grafar.set([color.g / 255]).select()
		let b = grafar.set([color.b / 255]).select()
